...
/*
 * This file is part of the WohlLabsCRUDBundle.
 *
 * Minor improvements to the Sensio CRUD Generator.
 *
 * (c) Jon Wohl <jon@wohllabs.com>
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
 */

namespace WohlLabs\Bundle\CRUDBundle\Command;
...
use WohlLabs\Bundle\CRUDBundle\Generator\WohlLabsCRUDGenerator;
use Sensio\Bundle\GeneratorBundle\Generator\DoctrineFormGenerator;
use Sensio\Bundle\GeneratorBundle\Command\GenerateDoctrineCommand;
use Sensio\Bundle\GeneratorBundle\Command\Helper\DialogHelper;
use Sensio\Bundle\GeneratorBundle\Command\Validators;
use Sensio\Bundle\GeneratorBundle\Generator\Generator;
use WohlLabs\Bundle\CRUDBundle\Manipulator\RoutingManipulator;
use Doctrine\ORM\Mapping\MappingException;

/**
 * Generates a CRUD controller.
 *
 * @author Jonathan Wohl <jon@wohllabs.com>
 */
class GenerateWohlLabsCRUDCommand extends GenerateDoctrineCommand
{
    private $generator;
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Minor but useful updates to the Sensio CRUD Generator')
            ->setHelp(<<<EOT
...
EOT
            ...
            ->setName('wohllabs:generate:crud')
            ->setAliases(array('generate:wohllabs:crud'))
        ;
    }
    ...
    protected function getGenerator()
    {
        if (null === $this->generator) {
            $this->generator = new WohlLabsCRUDGenerator($this->getContainer()->get('filesystem'), __DIR__.'/../Resources/skeleton/crud');
        }

        return $this->generator;
    }

    public function setGenerator(WohlLabsCRUDGenerator $generator)
    {
