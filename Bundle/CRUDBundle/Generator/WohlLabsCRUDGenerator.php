...
namespace WohlLabs\Bundle\CRUDBundle\Generator;
 ...
 */
class WohlLabsCRUDGenerator extends Generator
{
    private $filesystem;
    private $skeletonDir;
    private $routePrefix;
	...
	/**
     * Generates the base.html.twig template in the final bundle.
     *
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    private function generateBaseView($dir)
    {
        $this->renderFile($this->skeletonDir, 'views/base.html.twig', $dir.'/base.html.twig', array(
            'dir'               => $this->skeletonDir,
        ));
    }
